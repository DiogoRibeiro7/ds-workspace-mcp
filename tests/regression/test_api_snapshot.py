...
from ds_workspace_mcp.forecasting import (
    ...
    ForecastBaselineMetrics,
    ForecastBaselineResult,
    ForecastMetricNotes,
    GroupForecastBaselineResult,
)
...
EXPECTED_RESULT_MODEL_FIELDS = {
    ...
    "ManifestFeatureDecision": ["column", "decision", "reasons"],
    "ManifestTrainTestBoundaries": [
        "train_start_time",
        "train_end_time",
        "test_start_time",
    ...
    "ForecastBaselineMetrics": ["mae", "rmse", "mase", "smape"],
    "ForecastBaselineResult": [
        "baseline_name",
        "baseline_definition",
        "forecast_horizon",
    ...
    "ForecastMetricNotes": ["mae", "rmse", "mase", "smape"],
    "FrequencyInferenceResult": [
        "frequency",
        "frequency_kind",
        "confidence",
    ...
    "GroupForecastBaselineResult": ["group", "row_count", "frequency", "baselines"],
